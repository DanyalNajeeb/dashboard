...
@Component({
  selector: "app-reachedcustomer",
  templateUrl: "./reachedcustomer.component.html",
  styleUrls: ["./reachedcustomer.component.css"],
  animations: [
...
export class ReachedcustomerComponent implements OnInit {
  ...
  constructor(
    ...
    ELEMENT_DATA = this.orderService.getreachedCustomerOrder();
